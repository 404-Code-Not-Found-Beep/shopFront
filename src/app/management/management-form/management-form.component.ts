...
export class ManagementFormComponent {
  @Input()
  initialState: BehaviorSubject<any> = new BehaviorSubject({name:'', price: null, location:''});
  ...
  get name() { return this.managementForm.get('name')!; }
  get price() { return this.managementForm.get('price')!; }
  get url() { return this.managementForm.get('url')!; }
  get itemType() { return this.managementForm.get('itemType')!; }
  ...
  ngOnInit() {
    ...
    this.managementForm.valueChanges.subscribe((val) => { this.formValuesChanged.emit(val); });
  }
